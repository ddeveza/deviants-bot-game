  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col space-y-1">
        ...
        <p
          className={cn("uppercase text-[8px] proportional-nums font-bowlbyregular font-normal leading-[8px] -tracking-[0.48px]", isFullUpgrade ? "text-white" : "text-black")}
        >{`${xp} ${isFullUpgrade ? "TON" : "XP"}`}</p>
      </div>
    </div>
  );
};

...
const IncubationLanding = () => {
  ...
  return (
    <div className="bg-[#00CEB5] flex flex-col items-center justify-center h-dvh uppercase"> 
      ...
      />
      <button
        className="rounded-[20px] py-2.5 px-8 b text-[161313] bg-white font-normal leading-5 font-bowlby lining-nums  proportional-nums -tracking-[0.8px] z-[3]"
        onClick={handlePlay}
      >
        Continue
      </button>

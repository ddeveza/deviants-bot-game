...
export const LeaderContainer = () => {
  ...
  return (
    <div className="relative px-4 w-full flex flex-col gap-2 justify-start items-center stats-container">
      ...
      <div className="relative w-full leader-box pb-[8px] h-auto">
        <div className="relative w-full leader-box-inner px-2 py-2 gap-y-2 flex flex-col gap-2 justify-between items-start">
          ...
          {/* Clan Stats */}
          <h1 className="text-black font-bowlby text-lg uppercase w-full text-center">Leaderboards</h1>
          <div className="relative flex flex-col justify-center items-center w-full bg-[#DEDEDE] rounded-xl py-6 px-8 ">
            <h1 className="text-black font-chakra font-normal text-center text-xs">{`Leaderboard is empty.`}</h1>
          </div>
          ...
          <div className="relative h-[3rem] flex justify-between uppercase ui-container-button pt-2 pr-2">
            <div className="size-full flex justify-center items-center pb-[6px] relative gap-1 btn-green-container">
              ...
              <h1 className="text-white text-sm  font-bowlby relative">Find Me</h1>
            </div>
          </div>
